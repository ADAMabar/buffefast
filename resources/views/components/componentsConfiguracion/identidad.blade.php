            ...
            <div class="cfg-card">
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-5">
                        ...
                        <input type="text" class="form-control" name="eslogan" value="{{ $ajustes['eslogan'] ?? '' }}">
                    </div>
                </div>
            ...
            <div class="cfg-card">
                ...
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-sm-4 text-center">
                        <div id="logoWrap"
                            class="p-2 rounded border bg-light d-flex align-items-center justify-content-center"
            ...
            <div class="cfg-card flex-grow-1">
                ...
                <div class="row g-3 mb-3">
                    <div class="col-sm-6">
                        ...
                        <div class="input-group">
                            <span class="input-group-text bg-light border-end-0"><i
                                    class="bi bi-instagram text-muted"></i></span>
                            <input type="text" class="form-control border-start-0 ps-0" name="instagram"
                                value="{{ $ajustes['instagram'] ?? '' }}" placeholder="@usuario">
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <label class="cfg-label">Google Maps (Iframe)</label>
                        <div class="input-group">
                            <span class="input-group-text bg-light border-end-0">
                                <i class="bi bi-map text-muted"></i>
                            </span>

                            <input type="text" class="form-control border-start-0 ps-0" name="google_maps_url"
                                value="{{ $ajustes['google_maps_url'] ?? '' }}" placeholder="<iframe src=...">

                            <a href="https://adamabar.github.io/Gia-paso-a-paso-iframe-/" target="_blank"
                                class="btn btn-outline-secondary d-flex align-items-center"
                                title="¿Cómo obtener el iframe de Google Maps?">
                ...
                <div class="row g-3">
                    <div class="col-sm-6">
                        ...
                        <div class="input-group">
                            <span class="input-group-text bg-light border-end-0"><i
                                    class="bi bi-wifi text-muted"></i></span>
